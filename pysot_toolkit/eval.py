...
parser.add_argument('--dataset', '-d', type=str, default='list',
                    help='dataset name')
...
def main():
    ...
    """
    tracker_dir = os.path.join(args.tracker_path, 'lasot_raw_result')
    ...
    root = '/root/autodl-tmp/LaSOT/LaSOTTest/zip'
