...
parser.add_argument('--epnum', default='', type=int,
        help='id of eps')
...
def main():
    # load config
    dataset_root = '/root/autodl-tmp/UAV123' #Absolute path of the dataset
    # numid = str(args.epnum)
    net_path = "/root/autodl-tmp/checkpoints/SCATT_ep{:04d}.pth.tar".format(args.epnum)  #Absolute path of the model
