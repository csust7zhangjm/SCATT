...
parser.add_argument('--dataset', default='LaSOT', type=str,
        help='datasets')
...
def main():
    # load config
    # dataset_root = '/root/autodl-tmp/OTB100'
    dataset_root = '/root/autodl-tmp/LaSOT/LaSOTTest/zip' #Absolute path of the dataset
    net_path = '/root/autodl-tmp/checkpoints/SCATT.pth.tar' #Absolute path of the model

    # create model
    net = NetWithBackbone(net_path=net_path, use_gpu=True)
    tracker = Tracker(name='transt', net=net, window_penalty=0.490888, exemplar_size=128, instance_size=256)
